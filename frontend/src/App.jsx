        ...
        return (
          <button key={r} onClick={()=>onChange(r===active&&r!=="All"?"All":r)} title={r}
            style={{
              ...
              width:64, height:64,
              background: isActive ? `${col}20` : C.bgCard,
              border: `1.5px solid ${isActive ? col : C.border}`,
              borderRadius:12, cursor:"pointer", transition:"all .2s", position:"relative",
              boxShadow: isActive ? `0 0 14px ${col}66, inset 0 0 8px ${col}22` : "none",
            }}>
            {r==="All"
            ...
            <span style={{
              fontSize:9, letterSpacing:"0.04em", fontFamily:"Rajdhani,sans-serif",
            ...
            {isActive && (
              <div style={{ position:"absolute", bottom:0, left:"50%", transform:"translateX(-50%)", width:28, height:2, background:col, borderRadius:1 }} />
            )}
          </button>
        );
      })}
