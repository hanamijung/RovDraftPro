...
// ─── ROLE FILTER BAR ──────────────────────────────────────────────────────────
const ROLE_SVG = {
  All: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>,
  Tank: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5L12 1zm0 4l5 2.18V11c0 3.5-2.33 6.79-5 7.93-2.67-1.14-5-4.43-5-7.93V7.18L12 5z"/></svg>,
  Fighter: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M20.5 3l-.16.03L15 5.1 9 3 3.36 4.9c-.21.07-.36.25-.36.48V20.5c0 .28.22.5.5.5l.16-.03L9 18.9l6 2.1 5.64-1.9c.21-.07.36-.25.36-.48V3.5c0-.28-.22-.5-.5-.5zM10 18.42l-2-.67V5.58l2 .67v12.17zm6 .67l-2-.67V6.25l2 .67v12.17z"/></svg>,
  Assassin: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M18.5 3L21 5.5 12.38 14.12c.4.7.62 1.51.62 2.38C13 19.04 10.76 21 8.5 21S4 19.04 4 16.5 6.24 12 8.5 12c.87 0 1.68.22 2.38.62L18.5 3zm-10 11.5c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zM15 3l4 4-2 2-4-4 2-2zm-4 4l4 4-2 2-4-4 2-2z"/></svg>,
  Mage: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C8.5 2 5.6 4.07 4.34 7H3v2h1.09C4.03 9.65 4 10.32 4 11v1H3v2h1v1c0 .68.03 1.35.09 2H3v2h1.34C5.6 21.93 8.5 24 12 24s6.4-2.07 7.66-5H21v-2h-1.09c.06-.65.09-1.32.09-2v-1h1v-2h-1v-1c0-.68-.03-1.35-.09-2H21V7h-1.34C18.4 4.07 15.5 2 12 2zm0 2c2.76 0 5 2.24 5 5v6c0 2.76-2.24 5-5 5s-5-2.24-5-5V9c0-2.76 2.24-5 5-5zm-1 5v2h2V9h-2zm0 4v2h2v-2h-2z"/></svg>,
  Carry: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z"/><path d="M9.5 7.5l-1.5 1 4 3.5-4 3.5 1.5 1 5-4.5z"/></svg>,
  Support: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>,
};
      ...
      {tabs.map(r => {
        ...
        return (
          <button key={r} onClick={()=>onChange(r===active&&r!=="All"?"All":r)} title={r}
            ...
            <div style={{ width:26, height:26, color: isActive ? col : "#64748b" }}>
              {ROLE_SVG[r]}
            </div>
